  ...
  return (
    <>
      {user ? (
        ...
        <div className="h-screen w-screen flex flex-col items-center justify-center bg-slate-300 bg-opacity-30">
          <h1 className="text-3xl">
            Oops! Please login or sign up to access Kilowatt Island Surge.
          </h1>
          <button className="m-8 bg-neutral-200 shadow-md  hover:scale-105 hover:bg-orange-200 hover:bg-opacity-70 active:scale-110 active:bg-orange-200 shadow-gray-500 text-rose-950 bg-opacity-80 p-3 pr-4 pl-4 rounded-2xl">
            <a href="/api/auth/login">Login or Sign Up Here</a>
          </button>
        </div>
      )}
    </>
